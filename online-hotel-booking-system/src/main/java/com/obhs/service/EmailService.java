...
public class EmailService {
    ...
    @Value("${manager.email:manager@example.com}")
    ...
    public void sendBookingNotificationToManager(String customerName, Booking booking) throws MessagingException {
        ...
        String statusMessage = booking.getStatus() == Booking.BookingStatus.PENDING 
        ...
        String htmlContent = """
            ...
            <p>Best regards,<br>OHBS Team</p>
            """.formatted(
                String.format(statusMessage, customerName, booking.getHotel().getName(), booking.getStatus()),
                booking.getId(),
                customerName,
                booking.getHotel().getName(),
                booking.getRoom().getType(),
